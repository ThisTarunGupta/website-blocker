...
app.post('/add', (req, res) => {
  ...
  const result = '0.0.0.0  ' + req.body.website.toLowerCase() + '\n';
...
app.post('/delete', (req, res) => {
  ...
  let result = '127.0.0.1  localhost\n';
...
function withData(oldHTML, res) {
  let result = '';
  let template = '<tr><td><website></td><td><input type="checkbox" name="sites" value="<id>"></td></tr>';
  websites = [];
...
app.listen(3000, () => console.log('Open http://127.0.0.1:3000 in your favourite browser...'));
